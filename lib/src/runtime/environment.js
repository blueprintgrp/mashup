...
var Environment = /** @class */ (function () {
    ...
    Environment.prototype.declareVar = function (varname, value, constant) {
        if (this.variables.has(varname)) {
            console.log("Cannot declare variable ".concat(varname, ". As it already is defined."));
            process.exit(1);
        }
    ...
    Environment.prototype.assignVar = function (varname, value) {
        ...
        if (env.constants.has(varname)) {
            console.log("Cannot reasign to variable ".concat(varname, " as it's declared as a constant."));
            process.exit(1);
        }
    ...
    Environment.prototype.resolve = function (varname) {
        ...
        if (this.parent == undefined)
            console.log("Cannot resolve ".concat(varname, " as it does not exist."));
        process.exit(1);
